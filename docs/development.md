Development of qgis-plugin-template plugin
===========================
...
`git clone --recurse-submodules https://github.com/my-organization/qgis-plugin-template.git`
...
The code for the plugin is in the [qgisplugintemplate](../qgis-plugin-template) folder. Make sure you have required tools, such as
Qt with Qt Editor and Qt Linquist installed by following this
[tutorial](https://www.qgistutorials.com/en/docs/3/building_a_python_plugin.html#get-the-tools).

For building the plugin use platform independent [build.py](../qgis-plugin-template/build.py) script.

## Setting up development environment

To get started with the development, follow these steps:

1. Go to the  [qgisplugintemplate](../qgis-plugin-template) directory with a terminal
...
* they contain absolute imports:
    ```python
    from qgisplugintemplate.utils.exceptions import TestException # Good

    from ..utils.exceptions import TestException # Bad

    ```
* they will be found by [build.py](../qgisplugintemplate/build.py) script (`py_files` and `ui_files` values)

* you consider adding test files for the new functionality
## Deployment

Edit [build.py](../qgisplugintemplate/build.py) to contain working values for *profile*, *lrelease* and *pyrcc*. If you are
...
* Add this badge ![](https://github.com/my-organization/qgis-plugin-template/workflows/Translations/badge.svg) to
...
The translation files are in [i18n](../qgis-plugin-template/resources/i18n) folder. Translatable content in python files is
